...
const Summary = () => {
    ...
    return (
        <div>
            <Header2 />
            <div className='bg-gray-100 w-auto h-screen overflow-scroll '>
                <div className="flex ">
                    <div className='flex '>
                                    ...
                                    <table className="table-fixed border-collapse border border-gray-300 mt-2">
                                        ...
                                        <tbody className="bg-white">
                                            <tr className="bg-white border-collapse border border-gray-300 h-10">
                                                ...
                                                <td className="w-44 pl-14 "><div class="flex">110<AiOutlineArrowUp/></div></td>
                                            </tr>
                                            <tr className="bg-white border-collapse border border-gray-300 h-10">
                                                <td className="w-44 pl-14 ">ARD</td>
                                                <td className="w-44 pl-14 "><div class="flex">110<AiOutlineArrowUp/></div></td>
                                    ...
                                    <table className="table-fixed border-collapse border border-gray-300 mt-2">
                                        ...
                                        <tbody className="bg-white">
                                            <tr className="bg-white border-collapse border border-gray-300 h-10">
                                                ...
                                                <td className="w-40 pl-14 "><div class="flex">541<AiOutlineArrowDown/></div></td>
